    ...
    <Form {...form}>
      ...
      >
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Это название поля. <br /> Оно будет отображаться над полем
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Заполнитель поля.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Это дополнительное поле с текстом. <br />
                Оно отображается под названием.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Строк {form.watch("rows")}</FormLabel>
              <FormControl>
                <Slider
            ...
            <FormItem className="flex items-center justify-between rounded-lg border p-3 shadow-sm">
              <div className="space-y-0.5">
                ...
                <FormDescription>
                  ...
                  Оно будет отображаться под полем.
                </FormDescription>
              </div>
              <FormControl>
